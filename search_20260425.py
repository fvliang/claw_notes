#!/usr/bin/env python3
"""LLM serving paper search - 2026-04-25 morning"""
...
arxiv_queries = [
    ...
    "llm inference system scheduling batching",
    "speculative decoding verification draft",
...
s2_queries = [
    ...
    "LLM inference tensor pipeline parallel",
]
...
for p in all_papers:
    ...
    # Check multiple title lengths for matching
    is_existing = False
    for length in [80, 60, 50]:
