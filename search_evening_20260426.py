#!/usr/bin/env python3
"""LLM serving paper search - 2026-04-26 evening"""
...
# 1. ArXiv search - varied queries for broad coverage
arxiv_queries = [
    "llm serving system 2025",
    "speculative decoding llm efficient inference",
    "llm inference optimization throughput latency",
    "kv cache management llm serving",
    "llm inference scheduling batching serving",
    "continuous batching llm serving vllm",
    "llm serving disaggregation prefill decode",
    "moe llm inference serving routing",
    "llm inference acceleration draft model verification",
    "efficient llm inference quantization serving",
    "llm inference gpu kernel flash attention paged",
    "llm serving heterogeneous offloading cpu gpu",
...
s2_queries = [
    ...
    "LLM serving SIGCOMM SIGMOD NSDI",
]
